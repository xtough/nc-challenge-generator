# Spec: Artist Data Management

## Purpose

Manage the embedded dataset of artists and their associated styles, used to provide artist suggestions when generating Build-a-Prompt challenges. Supports offline use and optional resync from the Stable Diffusion cheat sheet.
